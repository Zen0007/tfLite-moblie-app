...
Future<List<Results>> dataFetch(
  ...
  var response = await http.get(
    Uri.parse(
      "https://api.polygon.io/v2/aggs/ticker/$name/range/1/day/${start.substring(0, 10)}/2024-08-21?adjusted=false&sort=desc&apiKey=3Nq8xQxfTb8xwIWUhGtaXbqhQUL_OHn4",
    ),
  );
  ...
  if (response.statusCode == 200) {
    ...
    //print("${temData} len data fetch stock");
    print("\t");
